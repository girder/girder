...
DEV_FUSE = '/dev/fuse'
SKIP_FUSE_TESTS = not os.path.exists(DEV_FUSE) or not stat.S_ISCHR(os.stat(DEV_FUSE).st_mode)


if not SKIP_FUSE_TESTS:  # noqa
    def setUpModule():
        base.startServer()
    ...
    class MountCommandTestCase(base.TestCase):
        ...
        def testMountCommand(self):
            ...
            subprocess.check_call([
                'girder', 'mount', mountPath, '-d', os.environ['GIRDER_TEST_DB']])
