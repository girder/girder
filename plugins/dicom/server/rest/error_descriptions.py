...
error_descriptions = {
    'WADO-RS': {
        206: 'Partial Content: Accept type, Transfer Syntax or decompression method '
             'supported for some but not all requested content.',
    ...
    'QIDO-RS': {
        400: 'Bad Request: The QIDO-RS Provider was unable to perform the query '
             'because the Service Provider cannot understand the query component.',
        401: 'Unauthorized: The QIDO-RS Provider refused to perform the query because '
             'the client is not authenticated.',
        403: 'Forbidden: The QIDO-RS Provider understood the request, but is refusing to '
             'perform the query (e.g., an authenticated user with insufficient privileges).',
        413: 'Request entity too large: The query was too broad and a narrower query or '
             'paging should be requested. The use of this status code should be documented '
             'in the conformance statement.',
        503: 'Busy: Service is unavailable.'
    },
    'STOW-RS': {
        400: 'Bad Request: This indicates that the STOW-RS Service was unable to store '
             'any instances due to bad syntax.',
        401: 'Unauthorized: This indicates that the STOW-RS Service refused to create or '
             'append any instances because the client is not authorized.',
        403: 'Forbidden: This indicates that the STOW-RS Service understood the request, '
             'but is refusing to fulfill it (e.g., an authorized user with insufficient '
             'privileges).',
        409: 'Conflict: This indicates that the STOW-RS Service request was formed correctly '
        ...
        415: 'Unsupported Media Type: This indicates that the STOW-RS Service does not support '
