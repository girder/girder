...
$(function () {
    describe('Test the settings page', function () {
        ...
        it('change the worker settings', function () {
            ...
            waitsFor(function () {
                return $('input.g-plugin-switch[key="remote_worker"]').length > 0;
            }, 'the plugins page to load');
            runs(function () {
                expect($('.g-plugin-config-link[g-route="plugins/remote_worker/config"]').length > 0);
                $('.g-plugin-config-link[g-route="plugins/remote_worker/config"]').click();
            });
            girderTest.waitForLoad();
            waitsFor(function () {
