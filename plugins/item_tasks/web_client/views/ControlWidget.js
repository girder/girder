...
var ControlWidget = View.extend({
    ...
    _input: function (evt) {
        ...
        if (this.model.get('type') === 'new-file') {
            // new-file is a special case that stores the user provided value in a
            // different place... value actually stores the parent model
            valueAttr = 'fileName';
        }

        // we don't want to rerender, because this event is generated by the input element
        this.model.set(valueAttr, val, {norender: true});
    },
