...
Existing installation may be upgraded by running ``pip install -U girder`` and
...
version: make sure to review
`Prerequisites <http://girder.readthedocs.io/en/latest/prerequisites.html>`_
