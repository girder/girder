...
<html lang="en">
  <head>
    ...
    <title>${brandName} - REST API Documentation</title>
  ...
  <body>
    <div class="docs-header">
      <span>${brandName} REST API Documentation</span>
    ...
    <div class="docs-body">
      ...
      the ${brandName} RESTful Web API. Click any of the resource links to open up a
