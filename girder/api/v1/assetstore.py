...
class Assetstore(Resource):
    ...
    @autoDescribeRoute(
        ...
        .param('useAcceleratedEndpoint', 'Whether to use an S3 accelerated endpoint for faster data'
               'transfers (for S3 type).', dataType='boolean', required=False, default=False)
        .errorResponse()
        .errorResponse('You are not an administrator.', 403)
    )
    def createAssetstore(self, name, type, root, perms, db, mongohost, replicaset, bucket,
                         ...
                         serverSideEncryption, useAcceleratedEndpoint):
        if type == AssetstoreType.FILESYSTEM:
            ...
            return self._model.createS3Assetstore(
                ...
                useAcceleratedEndpoint=useAcceleratedEndpoint)
        else:
    ...
    def updateAssetstore(self, assetstore, name, root, perms, db, mongohost, replicaset,
                         ...
                         inferCredentials, serverSideEncryption, useAcceleratedEndpoint, params):
        ...
        if assetstore['type'] == AssetstoreType.FILESYSTEM:
            ...
            assetstore['useAcceleratedEndpoint'] = useAcceleratedEndpoint
